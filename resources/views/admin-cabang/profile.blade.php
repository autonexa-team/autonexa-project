...
<div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4 animate-fade-slide-up stagger-1">
    <div>
        <h2 class="text-3xl font-bold text-slate-800 tracking-tight flex items-center gap-3">
            Profil Cabang
            <span class="bg-brand/10 text-brand text-xs font-bold px-2.5 py-1 rounded-full border border-brand/20">Cabang Sudirman</span>
        </h2>
                ...
                <div class="p-6 relative z-10">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" readonly value="AutoNexa Cabang Sudirman" class="w-full bg-slate-50 border border-slate-200 text-slate-600 text-sm rounded-xl px-4 py-2.5 outline-none font-semibold cursor-not-allowed shadow-inner">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Alamat Lengkap</label>
                            <textarea readonly class="w-full bg-slate-50 border border-slate-200 text-slate-600 text-sm rounded-xl px-4 py-2.5 outline-none font-semibold cursor-not-allowed resize-none shadow-inner" rows="3">Jl. Sudirman No. 45, Jakarta Pusat, DKI Jakarta</textarea>
                        </div>
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Latitude</label>
                                <input type="text" readonly value="-6.2088" class="w-full bg-slate-50 border border-slate-200 text-slate-600 text-sm rounded-xl px-4 py-2.5 outline-none font-semibold cursor-not-allowed shadow-inner">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Longitude</label>
                                <input type="text" readonly value="106.8456" class="w-full bg-slate-50 border border-slate-200 text-slate-600 text-sm rounded-xl px-4 py-2.5 outline-none font-semibold cursor-not-allowed shadow-inner">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden relative">
                <div class="p-6 relative z-10">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span class="bg-slate-50 text-slate-600 text-xs font-bold px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm">Ganti Oli Mesin</span>
                        <span class="bg-slate-50 text-slate-600 text-xs font-bold px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm">Servis Berkala</span>
                        <span class="bg-slate-50 text-slate-600 text-xs font-bold px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm">Ganti Kampas Rem</span>
                        <span class="bg-slate-50 text-slate-600 text-xs font-bold px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm">Tune Up Plus</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="time" name="jam_buka" value="08:00" class="w-full bg-white border border-slate-200 text-slate-800 text-sm rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand block pl-10 p-3 outline-none font-bold transition-all shadow-sm" required>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="time" name="jam_tutup" value="17:00" class="w-full bg-white border border-slate-200 text-slate-800 text-sm rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand block pl-10 p-3 outline-none font-bold transition-all shadow-sm" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-slate-100">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            ...
                            <label class="flex items-center justify-between p-3 border border-brand bg-brand/5 rounded-xl cursor-pointer hover:bg-brand/10 transition-colors shadow-sm group">
                                ...
                                <input type="checkbox" checked class="w-4 h-4 text-brand bg-gray-100 border-gray-300 rounded focus:ring-brand accent-brand cursor-pointer">
                            </label>
                            <label class="flex items-center justify-between p-3 border border-brand bg-brand/5 rounded-xl cursor-pointer hover:bg-brand/10 transition-colors shadow-sm group">
                            ...
                            <label class="flex items-center justify-between p-3 border border-slate-200 bg-white rounded-xl cursor-pointer hover:bg-slate-50 transition-colors opacity-60 shadow-sm group">
                                ...
                                <input type="checkbox" class="w-4 h-4 text-brand bg-gray-100 border-gray-300 rounded focus:ring-brand accent-brand cursor-pointer">
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row gap-6 items-start">
                        ...
                        <div class="w-full md:w-1/3 aspect-video md:aspect-square bg-slate-100 rounded-xl overflow-hidden border-2 border-dashed border-slate-300 flex items-center justify-center relative group shadow-inner">
                            <img src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81?q=80&w=600&auto=format&fit=crop" alt="Bengkel Cabang" class="w-full h-full object-cover z-0">
